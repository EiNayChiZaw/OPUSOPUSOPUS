...
public class ProductDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView productsideTextView = (TextView) findViewById(R.id.TextViewProductside);
        productsideTextView.setText(selectedProduct.icing);
        TextView productfillingTextView = (TextView) findViewById(R.id.TextViewProductfilling);
